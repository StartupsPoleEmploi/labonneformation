...
Message envoyé par <?php _T($from);?> depuis https://labonneformation.pole-emploi.fr à propos de la formation <?php _T($url);?>.
En cas d'abus, veuillez nous contacter par mail à l'adresse <?php _T(EMAIL_FROM) ?>.
...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<p style="font-size:85%">
			Message envoyé par <?php _T($from);?> depuis https://labonneformation.pole-emploi.fr à propos de la formation <a href="<?php _H($url) ?>"><?php _H($url) ?></a>.<br>
			En cas d'abus, veuillez nous contacter par mail à l'adresse <?php _T(EMAIL_FROM) ?>.
		</p>
	</body>
</html>
